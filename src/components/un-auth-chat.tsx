...
export default function UnAuthChat() {
  ...
  return (
    <Card className=" max-h-svh  flex justify-between flex-col rounded-none">
      <CardContent
        ref={latestMessageRef}
        className="max-h-[500px] shadow-sm py-0  mb-6 flex flex-col space-y-3 overflow-y-scroll scrollbar-none  "
      >
      ...
      <CardFooter className="bg-background fixed z-20 bottom-0 w-full">
        <Form {...form}>
          <form
